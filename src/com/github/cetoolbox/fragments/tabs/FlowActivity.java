	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<CharSequence> concentrationUnitsAdapter = ArrayAdapter
				.createFromResource(this, R.array.concentrationUnitArray,
						android.R.layout.flow_spinner_item);
		concentrationUnitsAdapter
				.setDropDownViewResource(android.R.layout.flow_spinner_dropdown_item);
	...
	public void onClick(View view) {
		if (view == calculate) {
			...
			if (validatedValues) {
				...
				View flowDetailsView = li.inflate(R.layout.simpleresults,
						null);

				AlertDialog.Builder builder = new AlertDialog.Builder(this);

				builder.setView(flowDetailsView);
				...
				if (isFull) {
					TextView tvMessage = (TextView) flowDetailsView
							.findViewById(R.id.flowMessage);
